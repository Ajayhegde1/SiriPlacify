...
export const getAllJobs = () => {
  return GET("/v2/jobs?jobType=current", {
    sessionID: store.getState().user.sessionId,
  });
};

export const getOfferJobs = () => {
  return GET("/v2/jobs?jobType=offer", {
    sessionID: store.getState().user.sessionId,
  });
};

export const getDeclinedJobs = () => {
  return GET("/v2/jobs?jobType=declined", {
    sessionID: store.getState().user.sessionId,
  });
};

export const getClosed = () => {
  return GET("/v2/jobs?jobType=closed", {
    sessionID: store.getState().user.sessionId,
  });
};
...
export const getJob = (id) => {
  return GET(`/job?jobID=${id}`, {
    sessionID: store.getState().user.sessionId,
  });
};

export const getPlacementPolicy = () => {
  return GET("/placementPolicy", {
    sessionID: store.getState().user.sessionId,
  });
};
...
export const addCollegeProfile = (data) => {
  return POST("/collegeProfile", data, {
    sessionID: store.getState().user.sessionId,
  });
};

export const addPlacementPolicy = (data) => {
  return POST("/placementPolicy", data, {
    sessionID: store.getState().user.sessionId,
  });
};
...
export const addJobsByCompany = (data) => {
  return POST("/companyJobs", data, {
    sessionID: store.getState().user.sessionId,
  });
};

export const getCompanyJobs = () => {
  return GET("/v2/jobs?jobType=open", {
    sessionID: store.getState().user.sessionId,
  });
};

export const getColleges = (jobID) => {
  return GET(`/colleges?jobID=${jobID}`, {
    sessionID: store.getState().user.sessionId,
  });
};

export const getOfferColleges = (jobID) => {
  return GET(`/offeredColleges?jobID=${jobID}`, {
    sessionID: store.getState().user.sessionId,
  });
};

export const sendOfferColleges = (data, jobID) => {
  return POST(`/offerColleges?jobID=${jobID}`, data, {
    sessionID: store.getState().user.sessionId,
  });
};

export const getAppliedStudents = (jobID) => {
  return GET(`/appliedStudents?jobID=${jobID}`, {
    sessionID: store.getState().user.sessionId,
  });
};

export const getCandidates = (jobID, collegeID) => {
  return GET(`/candidates?jobID=${jobID}&collegeID=${collegeID}`, {
    sessionID: store.getState().user.sessionId,
  });
};
...
export const updateProfile = (data) => {
  return POST("/updateCollegeProfile", data, {
    sessionID: store.getState().user.sessionId,
  });
};

export const updateCompanyProfile = (data) => {
  return POST("/updateCompany", data, {
    sessionID: store.getState().user.sessionId,
  });
};

export const updateJob = (jobID, data) => {
  return POST(`/updateJob?jobID=${jobID}`, data, {
    sessionID: store.getState().user.sessionId,
  });
};

export const updateJobTPO = (jobID, data) => {
  return POST(`/updateJobTPO?jobID=${jobID}`, data, {
    sessionID: store.getState().user.sessionId,
  });
};

export const updatePlacementPolicy = (data) => {
  return POST("/updatePlacementPolicy", data, {
    sessionID: store.getState().user.sessionId,
  });
};
...
export const addStudentProfile = (data) => {
  return POST("/studentProfile", data, {
    sessionID: store.getState().user.sessionId,
  });
};
...
export const applyJob = (data) => {
  return POST("/applyJobs", data, {
    sessionID: store.getState().user.sessionId,
  });
};

export const withdrawJob = (data) => {
  return POST("/withdrawJob", data, {
    sessionID: store.getState().user.sessionId,
  });
};

export const getStudentAppliedJobs = () => {
  return GET("/getJobApplications", {
    sessionID: store.getState().user.sessionId,
  });
};

export const getTPODashboard = () => {
  return GET("/getTPODashboard", {
    sessionID: store.getState().user.sessionId,
  });
};

export const getCompanyDashboard = () => {
  return GET("/companyDashboard", {
    sessionID: store.getState().user.sessionId,
  });
};
...
export const getTierOffers = () => {
  return GET("/getTiersDistribution", {
    sessionID: store.getState().user.sessionId,
  });
};
...
export const getCollegeAchievements = () => {
  return GET("/getCollegeAchievements", {
    sessionID: store.getState().user.sessionId,
  });
};

export const getBranchTrends = () => {
  return GET("/getCollegeBranchTrends", {
    sessionID: store.getState().user.sessionId,
  });
};
...
export const InternshipOffers = () => {
  return GET("/internshipOffers", {
    sessionID: store.getState().user.sessionId,
  });
};

export const getPlacementTrends = () => {
  return GET("/placementTrends", {
    sessionID: store.getState().user.sessionId,
  });
};
...
export const uploadResume = (filename, contentType) => {
  return GET(`/uploadResume?filename=${filename}&content_type=${contentType}`, {
    sessionID: store.getState().user.sessionId,
  });
};
...
export const uploadJobDescFile = (filename, ID) => {
  return GET(`/uploadJD?filename=${filename}&jobID=${ID}`, {
    sessionID: store.getState().user.sessionId,
  });
};

export const getJobDescFile = (ID) => {
  return GET(`/getJD?jobID=${ID}`, {
    sessionID: store.getState().user.sessionId,
  });
};

export const getCandidateResume = (id) => {
  return GET(`/getCandidateResume?studentID=${id}`, {
    sessionID: store.getState().user.sessionId,
  });
};

export const schedulePPT = (data) => {
  return POST("/schedulePPT", data, {
    sessionID: store.getState().user.sessionId,
  });
};

export const scheduleTest = (data) => {
  return POST("/scheduleTest", data, {
    sessionID: store.getState().user.sessionId,
  });
};

export const scheduleInterview = (data) => {
  return POST("/scheduleInterview", data, {
    sessionID: store.getState().user.sessionId,
  });
};

export const getSpecificJobApplication = (id) => {
  return GET(`/getJobApplication?id=${id}`, {
    sessionID: store.getState().user.sessionId,
  });
};
...
export const getJobData = (jobID, collegeID) => {
  return GET(`/getJobData?jobID=${jobID}&collegeID=${collegeID}`, {
    sessionID: store.getState().user.sessionId,
  });
};

export const reopenJobs = (data) => {
  return POST("/reopenJob", data, {
    sessionID: store.getState().user.sessionId,
  });
};
