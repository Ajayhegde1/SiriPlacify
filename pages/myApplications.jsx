  ...
  return (
    <div className="min-h-screen bg-gray-200">
      ...
      <main class={`dashboard ${sidebarOpen ? "active" : ""}`}>
        <h1 className="text-center md:text-left pt-6 mb-6 md:ml-12 pt-6 md:pt-16 text-3xl md:text-5xl  font-semibold text-green-800">
          My Applications
        </h1>
          ...
          <table className="pb-12 table-auto  rounded overflow-scroll w-full mt-3 text-left">
            ...
            <tbody className="bg-white  rounded-xl">
              {jobApplication === null ? (
                ...
                <div className="mt-4">No Applications found</div>
              ) : (
                jobApplication.map((job, index) => (
                  <tr
                    key={index}
                    className="mt-10 border-b-2 border-gray-200 hover:bg-gray-100 transiiton ease-in-out  "
                  >
                    ...
                    <td>
                      <button
                        onClick={() =>
                          handleCustomPage(job.collegeJobMappingId)
                        }
