...
export default function placementPolicy() {
  ...
  useEffect(() => {
    if (
      (numberOfTiers > 0 &&
        maxNumberOfOffers > 0 &&
        placementPolicyList.length > 0) === true
    ) {
    ...
    <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 lg:gap-4 xl:gap-6 2xl:gap-12 content-center">
        <div className="mt-4 py-4 md:py-12 pl-2 md:pl-6 xl:pl-8 ml-0 md:ml-4 xl:ml-6 mr-8 md:mr-10 xl:mr-12 2xl:mr-16">
          <h1 className="text-center md:text-left mb-10 ml-3 md:ml-6 mt-12 text-3xl md:text-4xl font-Heading font-medium text-black text-green-600">
            Placement Policy
          </h1>
          <div className="ml-6 ">
            ...
            {placementPolicyList.length < numberOfTiers ? (
              ...
              <div className="flex">
                <button className="cursor-not-allowed ml-auto bg-gray-500 text-white font-bold rounded-lg py-2 px-4">
                  No Tiers Added
                </button>
              </div>
            ) : (
              <div className="flex">
                <button className="ml-auto bg-gray-500 hover:bg-green-700 text-white font-bold rounded-lg py-2 px-4">
                  Max Tiers Added
                </button>
              </div>
            )}
