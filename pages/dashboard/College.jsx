              ...
              <div className='flex flex-col justify-center'>
                ...
                <div>
                  <h1 className='mt-1 font-DMSANS font-bold text-customGreenTwo text-center xl:text-4xl'>
                    {data === null
                      ? <Spin size='large' />
                      : Object.keys(data) === 0 ? 0 : data.noOfStudents}
                  </h1>
                </div>
              </div>
            </div>
              ...
              <div className='flex flex-col justify-center'>
                ...
                <div>
                  <h1 className='mt-1 font-DMSANS font-bold text-customGreenTwo text-center xl:text-4xl'>
                    {data === null
                      ? <Spin size='large' />
                      : Object.keys(data) === 0 ? 0 : data.noOfCompanies}
                  </h1>
                </div>
              </div>
            </div>
              ...
              <div className='flex flex-col justify-center'>
                ...
                <div>
                  <h1 className='mt-1 font-DMSANS font-bold text-customGreenTwo text-center xl:text-4xl'>
                    {data === null
                      ? <Spin size='large' />
                      : Object.keys(data) === 0 ? 0 : data.noOfStudentsPlaced}
                  </h1>
                </div>
              </div>
            </div>
              ...
              <div className='flex flex-col justify-center'>
                ...
                <div>
                  <h1 className='mt-1 font-DMSANS font-bold text-customGreenTwo text-center xl:text-4xl'>
                    {data === null
                      ? <Spin size='large' />
                      : Object.keys(data) === 0 ? 0 : data.noOfOffers}
                  </h1>
                </div>
              </div>
            </div>
                  ...
                  <div className='flex flex-col justify-center'>
                    ...
                    <div>
                      <h1 className='mt-1 font-DMSANS font-bold text-customGreenTwo text-center xl:text-4xl'>
                        {data === null
                          ? <Spin size='large' />
                          : Object.keys(data) === 0 ? 0 : data.noOfT1Offers}
                      </h1>
                    </div>
                  </div>
                </div>
                  ...
                  <div className='flex flex-col justify-center'>
                    ...
                    <div>
                      <h1 className='mt-1 font-DMSANS font-bold text-customGreenTwo text-center xl:text-4xl'>
                        {data === null
                          ? <Spin size='large' />
                          : Object.keys(data) === 0 ? 0 : data.noOfT2Offers}
                      </h1>
                    </div>
                  </div>
                </div>
                  ...
                  <div className='flex flex-col justify-center'>
                    ...
                    <div>
                      <h1 className='mt-1 font-DMSANS font-bold text-customGreenTwo text-center xl:text-4xl'>
                        {data === null
                          ? <Spin size='large' />
                          : Object.keys(data) === 0 ? 0 : data.noOfT3Offers}
                      </h1>
                    </div>
                  </div>
                </div>
                  ...
                  <div className='flex flex-col justify-center'>
                    ...
                    <div>
                      <h1 className='mt-1 font-DMSANS font-bold text-customGreenTwo text-center xl:text-2xl'>
                        {data === null
                          ? <Spin size='large' />
                          : Object.keys(data) === 0 ? 0 : data.meanPackage}
                      </h1>
                    </div>
                  </div>
                </div>
                  ...
                  <div className='flex flex-col justify-center'>
                    ...
                    <div>
                      <h1 className='mt-1 font-DMSANS font-bold text-customGreenTwo text-center xl:text-2xl'>
                        {data === null
                          ? <Spin size='large' />
                          : Object.keys(data) === 0 ? 0 : data.medianPackage}
                      </h1>
                    </div>
                  </div>
                </div>
                  ...
                  <div className='flex flex-col justify-center'>
                    ...
                    <div>
                      <h1 className='mt-1 font-DMSANS font-bold text-customGreenTwo text-center xl:text-2xl'>
                        {data === null
                          ? <Spin size='large' />
                          : Object.keys(data) === 0 ? 0 : data.highestPackage}
                      </h1>
                    </div>
                  </div>
                </div>
