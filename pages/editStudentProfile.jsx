    ...
    <div className="min-h-screen bg-gray-200">
      ...
      <main class={`dashboard ${sidebarOpen ? "active" : ""}`}>
        <div className="ml-10 mr-8 md:mr-20 pt-10">
          <p className="ml-3 md:ml-6 mb-12 font-SubHeading text-base font-normal">
          ...
          <div className="flex flex-col md:flex-row gap-4">
            <h1 className="text-center md:text-left mb-4 md:mb-10 ml-2 md:ml-6 mt-6 text-3xl md:text-4xl font-Heading font-bold text-black">
              Edit profile
            </h1>
            {profile === null ? (
              <div>
            ...
            ) : typeof profile.resumeFile === "undefined" ||
              ...
              <>
                <div className="ml-auto grid grid-cols-3 gap-2 mb-4 md:mb-0">
                  ...
                  >
                    <span className="mx-auto">View Resume</span>
                  </button>
                  <input
                    type="file"
                    accept=".pdf"
                  ...
                  <button
                    ...
                    className=" flex justify-center items-center h-16 md:h-10 ml-0 md:ml-auto bg-green-500 hover:bg-green-700 text-white font-semibold mt-2 md:mt-12 rounded text-sm py-2 px-6"
                  >
                    <span className="mx-auto">Update Resume</span>
                  </button>
                  <button
                    onClick={() => setShowModal(true)}
                    className="flex justify-center items-center h-16 md:h-10 bg-green-500 hover:bg-green-700 text-white font-semibold mt-2 md:mt-12 rounded text-sm py-2 px-6 "
