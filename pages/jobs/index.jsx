          ...
          <div>
            ...
            {user === null ? (
              ...
              jobSection === 1 ? (
                ...
                <JobOffers jobs={offerJobs} />
              ) : jobSection === 3 ? (
                <DeclinedJobs jobs={declinedJobs} jobSection={jobSection} />
              ) : (
                <DeclinedJobs jobs={closedJobCollege} jobSection={jobSection} />
              )
            ) : user.accType === "1" ? (
              jobSection === 1 ? (
                <CurrentJobs jobs={jobs} jobSection={jobSection} />
              ) : (
                <DeclinedJobs jobs={closedJobCollege} jobSection={jobSection} />
              )
            ) : user.accType === "2" ? (
              jobSection === 1 ? (
                ...
                <JobOffers jobs={closedJobs} />
              ) : (
                <div>You are not logged in or authorized to log in.</div>
              )
            ) : (
              <div>You are not logged in or authorized to log in.</div>
            )}
