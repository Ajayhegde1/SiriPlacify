...
export default function CandidatesPage() {
  ...
  const { candidateID, id } = router.query;
      ...
      <main class={`dashboard ${sidebarOpen ? "active" : ""}`}>
        ...
        <div className="mx-auto md:mx-20">
          <div className="flex gap-2">
            <h1 className="text-center md:text-left mb-10 ml-2 md:ml-6 mt-6 md:mt-12 text-3xl md:text-4xl lg:text-5xl 2xl:text-6xl font-Heading font-bold text-black">
              Student Profile
            </h1>
            <button
