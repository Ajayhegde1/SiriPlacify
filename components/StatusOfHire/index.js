    ...
    <div className='overflow-x-auto'>
      <div className='mt-4 ml-2 md:ml-6 flex flex-col lg:flex-row gap-4 lg:gap-16 border-b-2 border-gray-300'>
        ...
        >
          ...
          <span className='px-2 py-1 bg-gray-100 rounded-2xl text-blue-400 font-bold'>12</span>
        </div>
        <div
        ...
        >
          ...
          <span className='px-2 py-1 bg-gray-100 rounded-2xl text-blue-600 font-bold'>10</span>
        </div>
        <div
        ...
        >
          ...
          <span className='px-2 py-1 bg-gray-100 rounded-2xl text-red-400 font-bold'>10</span>
        </div>
        <div
        ...
        >
          ...
          <span className='px-2 py-1 bg-gray-100 rounded-2xl text-green-800 font-medium'>10</span>
        </div>
      </div>
    </div>
  )
