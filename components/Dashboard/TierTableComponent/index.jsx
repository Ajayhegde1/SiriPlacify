                        ...
                        Object.keys(tierOffers).length === 0 ?
                            ...
                            (
                                tierOffers.map((tierOffer) =>
                                    <tr class="border-b border-gray-300">
                                        <td class="py-2 px-4 text-base md:text-xl font-medium">{tierOffer.tier}</td>
                                        <td class="py-2 px-4 text-base md:text-xl text-left font-medium">{tierOffer.offers} offers</td>
                                    </tr>
                                )
                            )
                }
