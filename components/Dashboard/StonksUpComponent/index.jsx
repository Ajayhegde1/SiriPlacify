                        ...
                        <div class="my-auto ml-auto mr-4 flex items-center gap-1">
                            {
                                stonksType < 6
                                    ?
                                    <Image
                                        src={stonksType === 1 ? NIRF : stonksType === 2 ? stonksUp : stonksType === 3 ? stonksDown : stonksType === 4 ? planhire : stonksType === 5 ? hired : ''}
                                        alt="stonks up"
                                        class={stonksType !== 1 ? stonksType === 4 || stonksType === 5 ? "w-7 h-7" : "w-6 h-6" : 'w-8 h-8'}
                                    />
                                    :
                                    <></>
                            }
